...
import nl.tudelft.ipv8.jvm.demo.util.taproot.CTransaction
import nl.tudelft.ipv8.jvm.demo.util.taproot.MuSig
...
class DAOJoinHelper {
    ...
    companion object {
        ...
        fun joinAskBlockReceived(
            ...
            val trustchain = TrustChainHelper(IPv8Network.getInstance().getOverlay() ?: return)
            ...
            Log.i("COIN", joinBlock.SW_TRUSTCHAIN_PKS.size.toString())
            val signature =
